...
@Entity
@Table(name = "ticket_child_category_master")
public class TicketChildCategory {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "ticket_child_category_id", nullable = false)
	private Long ticketChildCategoryId;

	@Column(name = "child_category_name", nullable = false, length = 255)
