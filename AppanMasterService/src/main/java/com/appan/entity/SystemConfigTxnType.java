...
@Entity
@Table(name = "system_config_txntype_master")
public class SystemConfigTxnType {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "system_config_txntype_id", nullable = false)
	private Long systemConfigTxnTypeId;

	@Column(name = "code", nullable = false, length = 25, unique = true)
	private String code;

	@Column(name = "txn_type", nullable = false, length = 255)
